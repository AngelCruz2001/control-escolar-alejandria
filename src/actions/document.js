...
import {
  uiFinishLoading,
  uiFinishLoadingDocument,
  uiSetCurrent,
  uiStartLoading,
  uiStartLoadingDocument,
} from "./ui";
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const res = await fetchConToken(
        `documents/${document.idDocument}/students/${student.matricula}`,
        {
...
export const documentSetDocument = (idDocument) => ({
  type: types.documentSetDocument,
  payload: idDocument,
});
