...
import {
  expenseSetTypeExpense,
  expensesStartGetExpenses,
  expenseStartCreateRequest,
  expenseStartUpdateexpense,
...
export const ExpenseRecord = () => {
  const { idExpenseType, expenses, dataInputs, activeExpense } = useSelector(
  ...
  const handleSubmitSave = () => {
    activeExpense.id_expense
      ? dispatch(expenseStartUpdateexpense(activeExpense.id_expense, dataForm))
  ...
  return (
    <div className="exp__container">
      {isShowHistoryOpen ? (
        <HistoryExpenses expenses={expenses} />
      ) : (
        <>
