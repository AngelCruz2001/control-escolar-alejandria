    ...
    grades.data.forEach(
      ({
        ...
        const coincidence = isACoincidenceSearch(
          [student_name, matricula, group_name, major_name],
          searchWord
        );

        const dataBuilded = buildDataGrades(
          id_student,
          student_name,
          matricula,
          group_name,
    ...
    <>
      {isAStudentActive ? (
        ...
        <div className="gra__container">
          <Searchbar
            placeholder="Buscar por nombre, matrícula o grupo del estudiante"
